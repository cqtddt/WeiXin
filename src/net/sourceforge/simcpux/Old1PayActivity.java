		...
		appayBtn.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				try{
					...
					Toast.makeText(Old1PayActivity.this, "编码转换失败", Toast.LENGTH_SHORT).show();
				}
				...
				Toast.makeText(Old1PayActivity.this, "获取订单中...", Toast.LENGTH_SHORT).show();
		        try{
					...
					if (buf != null && buf.length > 0) {
						...
						if(null != json && 0 == json.getInt("retcode")){
							...
							Toast.makeText(Old1PayActivity.this, "正常调起支付", Toast.LENGTH_SHORT).show();
							// 在支付之前，如果应用没有注册到微信，应该先调用IWXMsg.registerApp将应用注册到微信
							api.sendReq(req);
						}else{
				        	Log.d("PAY_GET_TOKEN", "返回错误"+json.getString("retmsg"));
				        	Toast.makeText(Old1PayActivity.this, "返回错误"+json.getString("retmsg"), Toast.LENGTH_SHORT).show();
						}
					}else{
			        	Log.d("PAY_GET_TOKEN", "服务器请求错误");
			        	Toast.makeText(Old1PayActivity.this, "服务器请求错误", Toast.LENGTH_SHORT).show();
			        }
		        }catch(Exception e){
		        	Log.e("TASK_GET_TOKEN", "异常："+e.getMessage());
		        	Toast.makeText(Old1PayActivity.this, "异常："+e.getMessage(), Toast.LENGTH_SHORT).show();
		        }
